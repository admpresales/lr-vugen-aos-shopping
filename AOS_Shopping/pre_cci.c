# 1 "c:\\users\\demo\\documents\\vugen\\scripts\\dummy-vugen\\aos_shopping\\\\combined_AOS_Shopping.c"
...
# 1 "c:\\users\\demo\\documents\\vugen\\scripts\\dummy-vugen\\aos_shopping\\\\combined_AOS_Shopping.c" 2
...
# 2 "c:\\users\\demo\\documents\\vugen\\scripts\\dummy-vugen\\aos_shopping\\\\combined_AOS_Shopping.c" 2
...
# 3 "c:\\users\\demo\\documents\\vugen\\scripts\\dummy-vugen\\aos_shopping\\\\combined_AOS_Shopping.c" 2

# 1 "vuser_init.c" 1
# 1 "C:\\Program Files (x86)\\Micro Focus\\Virtual User Generator\\include/time.h" 1
...
# 11 "C:\\Program Files (x86)\\Micro Focus\\Virtual User Generator\\include/time.h" 2
...
vuser_init()
{
	...
	wait_time = lr_get_attrib_double("TranTime");  
	lr_message("The addtional attribute ""TranTime"" was set to %f", wait_time);
   
	scenarioStartTime = _time32(0);
 	return(0);
}

# 4 "c:\\users\\demo\\documents\\vugen\\scripts\\dummy-vugen\\aos_shopping\\\\combined_AOS_Shopping.c" 2
...
T00_AOS()
{
	...
	scenarioCurrentTime = _time32(0);
	runningTime = scenarioCurrentTime - scenarioStartTime;
	slowOverTime = runningTime * runningTime;  
 
	slowOverTime = slowOverTime/10.0;  
	...
	if (atoi(lr_eval_string("{FailRate}")) == 1) {
		...
		lr_end_transaction("T03_Purchase", 2);
    }
...
# 5 "c:\\users\\demo\\documents\\vugen\\scripts\\dummy-vugen\\aos_shopping\\\\combined_AOS_Shopping.c" 2
...
# 6 "c:\\users\\demo\\documents\\vugen\\scripts\\dummy-vugen\\aos_shopping\\\\combined_AOS_Shopping.c" 2
